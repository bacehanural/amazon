module.exports = {
    ...
    'amazon008'(client) {
        ...
        const registeredMailAddressSecondLogin = '.a-row.a-spacing-base > span';
       ...
       client.assert.screenshotIdenticalToBaseline(registeredMailAddressSecondLogin, 'registeredMailAddressSecondLogin');
