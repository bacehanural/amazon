module.exports = {
    ...
    const myBagDropDown = '.SiteTopHeaderRight .dropdown-toggle';
    ...
    .acceptCookies()        
        ...
        client.moveToElement('.SiteTopHeaderRight .dropdown-toggle', 50, 50);
        page
        .pause(6000)

        client.assert.screenshotIdenticalToBaseline(myBagDropDown, 'myBagDropDown');
    }
